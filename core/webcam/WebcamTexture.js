...
{	
	 ...
	 * @type {DOM}
	 */
	TONG.VideoTexture.call(this, video, mapping, wrapS, wrapT, TONG.LinearFilter, TONG.LinearFilter, TONG.RGBFormat, type, anisotropy);
...
WebcamTexture.prototype = Object.create(TONG.VideoTexture.prototype);
...
{	
	TONG.VideoTexture.prototype.dispose.call(this);
...
{
	var data = TONG.VideoTexture.prototype.toJSON.call(this, meta);
