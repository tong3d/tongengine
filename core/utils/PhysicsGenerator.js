...
/**
 * Physics generator is used to create Cannon.js shapes from TONG.js geometries.
 * 
...
//为选择的对象单独添加shape
PhysicsGenerator.createSingleShape = function(object, type){
    if(type !== undefined)
    {
    ...
    switch(object.geometry.type)
    {
        ...
        case "BoxBufferGeometry":
            return PhysicsGenerator.createBoxShape(object.geometry);
        case "CylinderGeometry":
        case "CylinderBufferGeometry":
            return PhysicsGenerator.createCylinderShape(object.geometry);

        case "SphereGeometry":
        case "SphereBufferGeometry":
            return PhysicsGenerator.createSphereShape(object.geometry);
        case "PlaneGeometry":
...
PhysicsGenerator.createShape = function(object, type)
{
	...
	switch(geometry.type)
	{
		...
		case "BufferGeometry":
			return PhysicsGenerator.createConvexPolyhedron(object);
		default:
			return PhysicsGenerator.createConvexPolyhedron(geometry);
	}
};
...
PhysicsGenerator.createBoundingBoxShape = function(object)
{
	...
	var worldPosition = new TONG.Vector3();
...
PhysicsGenerator.createConvexPolyhedron = function(object)
{
	...
	if(geometry instanceof TONG.BufferGeometry)
	{
		geometry = new TONG.Geometry().fromBufferGeometry(geometry);
	}
	...
	//Convert from TONG.Face to Array<number>
...
{
	var tmp = new TONG.BufferGeometry();
	tmp.fromGeometry(geometry);
	return PhysicsGenerator.createTrimeshShape(tmp);
};
...
PhysicsGenerator.getGeometry = function(object)
{
	...
	{
		var combined = new TONG.Geometry();
		var mesh;
		...
		while((mesh = meshes.pop()))
		{
			...
			if(mesh.geometry instanceof TONG.BufferGeometry)
			{
...
PhysicsGenerator.getVertices = function(geometry)
{
	...
	{
		geometry = new TONG.BufferGeometry().fromGeometry(geometry);
	}
	return geometry.attributes.position.array;
};

/**
 * Returns a array of TONG.Mesh instances from the given object.
 * 
