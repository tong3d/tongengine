...
function ParticleEmitter(group, emitter)
{
	 ...
	 * @type {SPE.Group}
	 */
	this.group = new ParticleSystem.Group(group !== undefined ? group : ParticleEmitter.defaultGroup);
	 ...
	 * @type {SPE.Emitter}
	 */
	this.emitter = new ParticleSystem.Emitter(emitter !== undefined ? emitter : ParticleEmitter.defaultEmitter);
	this.group.addEmitter(this.emitter);

	TONG.Points.call(this, this.group.geometry, this.group.material);
...
ParticleEmitter.prototype = Object.create(TONG.Points.prototype);
...
{		
	...
	velocity:
	{
		value: new TONG.Vector3(0, 0, 0),
		spread: new TONG.Vector3(3, 3, 3)
	},
	acceleration:
	{
		value: new TONG.Vector3(0, 0, 0),
		spread: new TONG.Vector3(0, 0, 0)
	}
};
...
ParticleEmitter.defaultGroup = 
{
	texture:
	{
		value: new TONG.TextureLoader().load("./imgs/particle/particle.png")
	},
...
ParticleEmitter.prototype.dispose = function()
{
	...
	//TONG.Object3D.prototype.dispose().bind(this);
};
...
{
	var data =TONG.Object3D.prototype.toJSON.call(this, meta);// TONG.Object3D.prototype.toJSON.call(this, meta);
...
ParticleSystem.Group.prototype.toJSON = function(meta)
{
	var data = {};
...
ParticleSystem.Emitter.prototype.toJSON = function(meta)
{
	var data = {};
