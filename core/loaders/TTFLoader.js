...
TONG.TTFLoader = function ( manager ) {
...
TONG.TTFLoader.prototype.load = function ( url, onLoad, onProgress, onError ) {
...
TONG.TTFLoader.prototype.parse = function ( arraybuffer ) {
