...
TONG.Lensflare.prototype = Object.create( TONG.Mesh.prototype );
TONG.Lensflare.prototype.constructor = TONG.Lensflare;
TONG.Lensflare.prototype.isLensflare = true;

//

TONG.LensflareElement = function ( texture, size, distance, color ) {

	this.texture = texture;
	this.size = size || 1;
	this.distance = distance || 0;
	this.color = color || new TONG.Color( 0xffffff );

};

TONG.LensflareElement.Shader = {
...
TONG.Lensflare.Geometry = ( function () {
	...
	var interleavedBuffer = new TONG.InterleavedBuffer( float32Array, 5 );

	geometry.setIndex( [ 0, 1, 2,	0, 2, 3 ] );
	geometry.addAttribute( 'position', new TONG.InterleavedBufferAttribute( interleavedBuffer, 3, 0, false ) );
	geometry.addAttribute( 'uv', new TONG.InterleavedBufferAttribute( interleavedBuffer, 2, 3, false ) );
