...
function Mouse()
{
	...
	this._position = new TONG.Vector2(0, 0);
	this._positionUpdated = false;
	this._delta = new TONG.Vector2(0, 0);
	this._wheel = 0;
	 ...
	 * @property position
	 */
	this.position = new TONG.Vector2(0,0);
	 ...
	 * @property delta
	 */
	this.delta = new TONG.Vector2(0,0);
	...
	if("ontouchstart" in window || navigator.msMaxTouchPoints > 0)
	{
		...
		var lastTouch = new TONG.Vector2(0, 0);
