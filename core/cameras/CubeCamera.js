...
function CubeCamera(near, far, resolution, autoUpdate)
{
	...
	for(var i = 0; i < 6; i++)
	{
		var camera = new TONG.PerspectiveCamera(90, 1, this.near, this.far);
		camera.parent = this;
		this.cameras.push(camera);
	}

	this.cameras[0].up.set(0, -1, 0);
	this.cameras[0].lookAt(new TONG.Vector3(1, 0, 0));
	this.cameras[1].up.set(0, -1, 0);
	this.cameras[1].lookAt(new TONG.Vector3(-1, 0, 0));
	this.cameras[2].up.set(0, 0, 1);
	this.cameras[2].lookAt(new TONG.Vector3(0, 1, 0));
	this.cameras[3].up.set(0, 0, -1);
	this.cameras[3].lookAt(new TONG.Vector3(0, -1, 0));
	this.cameras[4].up.set(0, -1, 0);
	this.cameras[4].lookAt(new TONG.Vector3(0, 0, 1));
	this.cameras[5].up.set(0, -1, 0);
	this.cameras[5].lookAt(new TONG.Vector3(0, 0, -1));
	 ...
	 */
	this.target = new TONG.WebGLRenderTargetCube(this.resolution, this.resolution,
	{
...
TONG._CubeCamera = TONG.CubeCamera;
TONG.CubeCamera = CubeCamera;

CubeCamera.prototype = Object.create(TONG.Object3D.prototype);
...
CubeCamera.prototype.update = function(delta)
{
	...
	TONG.Object3D.prototype.update.call(this, delta);
};
