...
function Font(url)
{
	ResourceSys.call(this, "font", "Font");
...
Font.prototype = Object.create(ResourceSys.prototype);
...
Font.fileIsFont = function(file)
{
	if(file !== undefined)
	{
		...
		return file.endsWith("ttf") || file.endsWith("otf") || file.endsWith("ttc") || file.endsWith("otc") || file.endsWith("font")
            || file.endsWith("fnt");
	}
...
Font.prototype.clone=function(){
	...
	font.reversed=this.reversed;
	font.data=this.data;
	font.format=this.format;
	return font;
...
Font.prototype.generateShapes = function(text, size, divisions)
{
	...
	function createPath(c, scale, offsetX, offsetY)
	{
		...
		var path = new TONG.ShapePath();

		//Temporary variables
		var pts = [], b2 = TONG.ShapeUtils.b2, b3 = TONG.ShapeUtils.b3;
