...
function SSAOPass()
{
	if(TONG.SSAOShader === undefined)
	{
		console.warn("SSAOPass depends on THREE.SSAOShader");
	}

	ShaderPass.call(this, TONG.SSAOShader);
	...
	//Depth render target
	this.depthRenderTarget = new TONG.WebGLRenderTarget(2, 2, {minFilter: TONG.LinearFilter, magFilter: TONG.LinearFilter});
